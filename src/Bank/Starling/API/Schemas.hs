...
newtype DirectDebitMandates = DirectDebitMandates
...
newtype NextPaymentDatesResponse = NextPaymentDatesResponse
...
newtype PaymentOrderPaymentsResponse = PaymentOrderPaymentsResponse
...
newtype ScheduledPayments = ScheduledPayments
...
newtype StandingOrdersResponse = StandingOrdersResponse
